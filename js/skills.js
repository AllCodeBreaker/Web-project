...
const skills = {
    "skill": [
        {
        "name": "Photoshop",
        "svg": "<img class=\"skill-img\" src=\"image/photoshop.jpeg\">"
    },
    {
        "name": "Blender",
        "svg":  "<img class=\"skill-img\" src=\"image/blender.jpeg\">"
    },
    {
        "name": "Fl Studio",
        "svg":  "<img class=\"skill-img\" src=\"image/fl-studio.jpeg\">"
    },
    {
        "name": "After Effects",
        "svg": "<img class=\"skill-img\" src=\"image/after-effects.png\">"

    },
    {
        "name": "Premiere Pro",
        "svg": "<img class=\"skill-img\" src=\"image/premiere-pro.png\">"
...
window.addEventListener("load", (e)=>{
    ...
    let wholeTemp = "<h3>WHAT I WORK WITH</h3><div class=\"skill-container\">";
    const preTemp = " <div class=\"skill\" >";
    const postTemp = " </div>";
    for(let i = 0;i<skills.skill.length; i++){
        let svgName = skills.skill[i].svg + "<span class=\"skill-name\">"+ skills.skill[i].name +"</span>";
        wholeTemp = wholeTemp + preTemp + svgName + postTemp;
    }
    wholeTemp = wholeTemp + "</div>";
    skillElement.innerHTML = wholeTemp;
